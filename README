...
Автоматически скрывает скууму и сахар от торговцев, которые не хотят иметь с ними дела. (Просто нажмите «Торговать» ещё раз после получения отказа.)
...
Используйте эту версию если у вас установлен Morrowind Code Path и включена опция «Фильтр отказа отпредоставления услуг» (или же вы используете OpenMW — он поддерживает это). Она полностью убирает сообщения, касающиеся скуумы и Лунного Сахара, при попытках воспользоваться сервисами, отличными от Торговли. Если вы попытаетесь использовать эту версию без необходимой поддержки со стороны установленной игры, вы обнаружите, что все торговцы покупают скууму.
